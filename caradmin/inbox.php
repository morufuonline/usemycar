...
?>
<form action="inbox.php" method="post" runat="server" autocomplete="off" enctype="multipart/form-data" style="overflow-x:auto;" onsubmit="javascript: return confirm('Are you sure you want to delete the selected messages?');">
