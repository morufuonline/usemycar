...
redirect("{$directory}{$admin}login.php");
...
<span><?php
$file_array = glob("../images/admin/{$id}pic*.jpg");
...
<a href="cars-for-sales.php" class="<?php echo current_page("cars-for-sales"); ?>"><i class="fa fa-car" aria-hidden="true"></i> Cars for Sale</a>
<a href="plan-orders.php" class="<?php echo current_page("plan-orders"); ?>"><i class="fa fa-car" aria-hidden="true"></i> Plan Orders</a>
