...
redirect("{$directory}");
$_SESSION["msg"] = "<div class='alert alert-danger alert-dismissable fade in'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> You are not logged in as a user. Kindly log in to continue...</div>";
}
?>
            ...
            <div class="row">
               ...
               <div class="col-md-8 col-sm-9">
                  <ul class="head-right-menu">
                     ...
                     <li><a href="sell-your-car-01.php">SELL YOUR CAR</a></li>
